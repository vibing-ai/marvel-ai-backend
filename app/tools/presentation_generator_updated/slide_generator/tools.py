...
class Slide(BaseModel):
    ...
    image_url: Optional[str] = Field(None, description="URL of the generated image for the slide")  # ✅ Added image_url field
...
class SlideGenerator:
        ...
        try:
            ...
            for slide in slides:
                ...
                if isinstance(slide["content"], list):
                    slide_text = ' '.join(map(str, slide["content"]))
                elif isinstance(slide["content"], dict):
                    slide_text = ' '.join(map(str, slide["content"].values()))
                else:
    ...
    def generate_slides(self):
        logger.info("Generating full presentation slides...")  # ✅ clearer message
