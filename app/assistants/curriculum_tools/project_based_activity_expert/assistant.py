...
model = genai.GenerativeModel(model_name='gemini-2.0-flash-exp',
                              system_instruction=read_text_file('prompt/project_based_activity_expert_context.txt'))


def run_project_based_activity_expert(user_query=str, chat_context=str, user_info=UserInfo):
